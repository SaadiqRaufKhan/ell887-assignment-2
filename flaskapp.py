...
params = urllib.parse.quote_plus("DRIVER={ODBC Driver 17 for SQL Server};SERVER=assignmentserver351.database.windows.net;DATABASE=assignmentDatabase;UID=saadiqrk;PWD=Cloud351")
